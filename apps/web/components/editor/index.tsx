  ...
  return (
    ...
    <div className="flex flex-col h-screen bg-gray-100 overflow-hidden">
      ...
      <div className="flex flex-1 pt-[53px] overflow-hidden">
        ...
        >
          <div
            className={`flex justify-center items-center space-x-4 py-4 transition-transform duration-500 ease-in-out ${isDrawerOpen || isImageDrawerOpen ? "-translate-x-1/2" : "translate-x-0"}`}
          >
            <button
          ...
          <div
            className={`flex-1 relative overflow-hidden transform transition-transform duration-500 ease-in-out ${isDrawerOpen || isImageDrawerOpen ? "-translate-x-1/4" : "translate-x-0"}`}
          >
